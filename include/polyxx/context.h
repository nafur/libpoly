...
namespace poly
{
    ...
    public:
        Context();
        /** Get a non-const pointer to the internal lp_variable_db_t. Handle with care!
   */
        lp_variable_db_t *get_variable_db() const;

        /** Get a non-const pointer to the internal lp_variable_order_t. Handle with care!
   */
        lp_variable_order_t *get_variable_order() const;

        /** Get a non-const pointer to the internal lp_polynomial_context_t. Handle with care!
   */
