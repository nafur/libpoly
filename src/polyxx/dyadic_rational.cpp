...
namespace poly
{
    ...
    DyadicRational::DyadicRational()
    {
        lp_dyadic_rational_construct(&mDRat);
    }
    ...
    DyadicRational::~DyadicRational()
    {
        lp_dyadic_rational_destruct(&mDRat);
    }
    ...
    lp_dyadic_rational_t *DyadicRational::get_internal()
    {
        return &mDRat;
    }
    ...
    {
        return lp_dyadic_rational_cmp_integer(lhs.get_internal(), rhs.get_internal()) == 0;
    }
    bool operator!=(const DyadicRational &lhs, const Integer &rhs)
    {
        return lp_dyadic_rational_cmp_integer(lhs.get_internal(), rhs.get_internal()) != 0;
...
/*    bool operator==(const DyadicRational &lhs, const Rational &rhs)
    {
        return lp_dyadic_rational_cmp_rational(lhs.get_internal(), rhs.get_internal()) == 0;
    }
    bool operator!=(const DyadicRational &lhs, const Rational &rhs)
    {
        return lp_dyadic_rational_cmp_rational(lhs.get_internal(), rhs.get_internal()) != 0;
    ...
    {
        DyadicRational res;
        lp_dyadic_rational_add(res.get_internal(), lhs.get_internal(), rhs.get_internal());
        return res;
    }
    DyadicRational operator+(const DyadicRational &lhs, const Integer &rhs)
    {
        DyadicRational res;
        lp_dyadic_rational_add_integer(res.get_internal(), lhs.get_internal(), rhs.get_internal());
        return res;
    }
    ...
    {
        DyadicRational res;
        lp_dyadic_rational_sub(res.get_internal(), lhs.get_internal(), rhs.get_internal());
        return res;
    }
    ...
    {
        DyadicRational res;
        lp_dyadic_rational_mul(res.get_internal(), lhs.get_internal(), rhs.get_internal());
        return res;
    }
