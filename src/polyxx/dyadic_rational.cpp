...
{
  return lp_dyadic_rational_cmp_integer(lhs.get_internal(), rhs.get_internal())
         == 0;
}
bool operator!=(const DyadicRational& lhs, const Integer& rhs)
{
...
{
  DyadicRational res;
  lp_dyadic_rational_add_integer(
      res.get_internal(), lhs.get_internal(), rhs.get_internal());
  return res;
}
