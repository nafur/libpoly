...
Integer::Integer(const char* x, int base) : Integer(IntegerRing::Z, x, base) {}
...
{
  lp_integer_construct_from_rational(
      ir.get_internal(), &mInt, r.get_internal());
}
...
{
  return lp_integer_cmp(
      ir.get_internal(), lhs.get_internal(), rhs.get_internal());
}
...
{
  lp_integer_add(ir.get_internal(),
                 lhs.get_internal(),
                 lhs.get_internal(),
                 rhs.get_internal());
  return lhs;
...
{
  lp_integer_sub(ir.get_internal(),
                 lhs.get_internal(),
                 lhs.get_internal(),
                 rhs.get_internal());
  return lhs;
...
{
  lp_integer_mul(ir.get_internal(),
                 lhs.get_internal(),
                 lhs.get_internal(),
                 rhs.get_internal());
  return lhs;
...
{
  lp_integer_mul_int(
      ir.get_internal(), lhs.get_internal(), lhs.get_internal(), rhs);
  return lhs;
}
...
Integer mul_pow2(IntegerRing& ir, const Integer& lhs, unsigned rhs)
{
  Integer res;
  lp_integer_mul_pow2(
      ir.get_internal(), res.get_internal(), lhs.get_internal(), rhs);
  return res;
}
...
Integer& add_mul(IntegerRing& ir,
                 ...
                 const Integer& b)
{
  lp_integer_add_mul(ir.get_internal(),
                     lhs.get_internal(),
                     a.get_internal(),
                     b.get_internal());
  return lhs;
...
{
  lp_integer_add_mul_int(
      ir.get_internal(), lhs.get_internal(), a.get_internal(), b);
  return lhs;
}
...
Integer& sub_mul(IntegerRing& ir,
                 ...
                 const Integer& b)
{
  lp_integer_sub_mul(ir.get_internal(),
                     lhs.get_internal(),
                     a.get_internal(),
                     b.get_internal());
  return lhs;
...
Integer& operator/=(Integer& lhs, const Integer& rhs)
{
  lp_integer_div_Z(lhs.get_internal(), lhs.get_internal(), rhs.get_internal());
  return lhs;
}
...
Integer& operator%=(Integer& lhs, const Integer& rhs)
{
  lp_integer_rem_Z(lhs.get_internal(), lhs.get_internal(), rhs.get_internal());
  return lhs;
}
...
{
  Integer res;
  lp_integer_div_exact(ir.get_internal(),
                       res.get_internal(),
                       lhs.get_internal(),
                       rhs.get_internal());
  return res;
...
{
  Integer res;
  lp_integer_div_rem_Z(res.get_internal(),
                       rem.get_internal(),
                       lhs.get_internal(),
                       rhs.get_internal());
  return res;
...
{
  Integer res;
  lp_integer_div_rem_pow2_Z(
      res.get_internal(), rem.get_internal(), lhs.get_internal(), rhs);
  return res;
}
...
std::size_t hash(const Integer& i) { return lp_integer_hash(i.get_internal()); }
